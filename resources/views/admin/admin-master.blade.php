            ...
            <div class="tab-content">
                <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
                    <div class="media-list">
                        ...
                        <a href="" class="media-list-link">
                            <div class="media">
                                <img src="{{ asset('dashboard') }}/img/img3.jpg" class="wd-40 rounded-circle" alt="">
                        ...
                        <a href="" class="media-list-link">
                            <div class="media">
                                <img src="{{ asset('dashboard') }}/img/img4.jpg" class="wd-40 rounded-circle" alt="">
                                <div class="media-body">
                        ...
                        <a href="" class="media-list-link">
                            <div class="media">
                                <img src="{{ asset('dashboard') }}/img/img7.jpg" class="wd-40 rounded-circle" alt="">
                                <div class="media-body">
                                    <p class="mg-b-0 tx-medium tx-gray-800 tx-13">Robert Walker</p>
                                    <span class="d-block tx-11 tx-gray-500">5 hours ago</span>
                                    <p class="tx-13 mg-t-10 mg-b-0">I should be incapable of drawing a single stroke at the
                                        present moment{{ asset('dashboard') }}.</p>
                                </div>
                            </div><!-- media -->
                        </a>
                        <a href="" class="media-list-link">
                            <div class="media">
                                <img src="{{ asset('dashboard') }}/img/img5.jpg" class="wd-40 rounded-circle" alt="">
                                <div class="media-body">
                                    <p class="mg-b-0 tx-medium tx-gray-800 tx-13">Larry Smith</p>
                                    <span class="d-block tx-11 tx-gray-500">Yesterday, 8:34pm</span>

                                    <p class="tx-13 mg-t-10 mg-b-0">When, while the lovely valley teems with vapour around
                                        me, and the meridian sun strikes{{ asset('dashboard') }}.</p>
                                </div>
                            </div><!-- media -->
                        </a>
                        <a href="" class="media-list-link">
                ...
                <div class="tab-pane pos-absolute a-0 mg-t-60 overflow-y-auto" id="notifications" role="tabpanel">
                    <div class="media-list">
                        ...
                        <a href="" class="media-list-link read">
                            <div class="media pd-x-20 pd-y-15">
                                <img src="{{ asset('dashboard') }}/img/img9.jpg" class="wd-40 rounded-circle" alt="">
                                <div class="media-body">
                        ...
                        <a href="" class="media-list-link read">
                            <div class="media pd-x-20 pd-y-15">
                                <img src="{{ asset('dashboard') }}/img/img10.jpg" class="wd-40 rounded-circle" alt="">
                                <div class="media-body">
